var pageSection,
  ...
  viewAllVisualTemplate =
    '<div class="grid-item grid-sizer photography"><div class="thumbnail rounded img-scale-in" data-hover-easing="easeInOut" data-hover-speed="700" data-hover-bkg-color="#ffffff" data-hover-bkg-opacity="0.9"><a class="overlay-link" href="@url"><img src="@img" alt=""/><span class="overlay-info"><span><span><span class="project-title">@name</span></span></span></span></a></div></div>';
